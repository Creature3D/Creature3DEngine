...
protected:
	...
	std::string m_canGet[7];
	std::string m_canGetBackBoard[7];
};
...
public:
	...
	void setTitleText(int tiaojian1,int tiaojian2, int title, int neirong,int cishu, const CREncapsulation::crTableIO::StrVec &record, CRUI::crHypertextWidgetNode * hyp, CRUI::crStaticTextWidgetNode *text=NULL);
protected:
	CRCore::crCanvasNode *m_this;
	...
	std::string m_superEquipTitle[4];
	std::string m_superEquipText[4];
	std::string m_superEquipButton[4];
	std::string m_pagesw;
};
