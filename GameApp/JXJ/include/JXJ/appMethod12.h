...
class crJXJUIResAddBuildingCanvasUpdateMethod :public CRCore::crMethod
{//Client Method
public:
	crJXJUIResAddBuildingCanvasUpdateMethod();
	crJXJUIResAddBuildingCanvasUpdateMethod(const crJXJUIResAddBuildingCanvasUpdateMethod& handle);
	MethodClass(JXJ, JXJUIResAddBuildingCanvasUpdate)
	virtual void operator()(crHandle &handle);
	virtual void inputParam(int i, void *param);
	virtual void addParam(int i, const std::string& str);
protected:
