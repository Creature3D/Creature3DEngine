...
public:
	...
	int getID();
	//CRCore::crStreamBuf *getStream();
	unsigned short getCyclecount();
	int getMoney();
	int getTotaladdmoney();
	int getVipExp();
	JXJStoreItemBagVec &getCardBagVec();
	JXJStoreItemBagVec &getItemBagVec();
	const std::string & getSuper();
	static void getCardAndItemStr(std::string &cardstr, std::string &itemstr);
protected:
	int m_id;
	int m_money;
	int m_totaladdmoney;
...
public:
	...
	void buildUpdateSql_Cycle(int playerid, int gameid, int cycleCountAdd, int money, int totaladdmoney,int vipexp,const std::string &super);
};
...
public:
	...
	void buildUpdateSql(int playerid, int gameid, int cyclecount, int money, int totaladdmoney, int vipexp, JXJStoreItemBagVec & cardVec, JXJStoreItemBagVec & itemVec,const std::string &super);
};
...
public:
	...
	void buildUpdateSql_Cycle(int id, int serverid, int cycleCountAdd, int money, int totaladdmoney,int vipexp,JXJStoreItemBagVec & cardVec, JXJStoreItemBagVec & itemVec,const std::string &super);
	void buildUpdateSql_Distill(int id, int distillmoney, int distilltotalmoney, int distillvipexp, std::vector<int>&cardVec, std::vector<int>&itemVec);
	void buildUpdateSql_Distill(int id, const std::string &super);
};
