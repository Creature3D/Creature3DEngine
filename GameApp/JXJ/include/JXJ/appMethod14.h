...
protected:
	...
	CRCore::crVector2i m_achieveid6;
};
...
protected:
	...
	std::string m_strCardQuality[CycleCardOnePageCount];
	std::string m_strCardImage[CycleCardOnePageCount][2];
	std::string m_strItemImage[CycleItemOnePageCount][2];
	std::string m_strCardStatus[CycleCardOnePageCount];
	std::string m_strItemStatus[CycleItemOnePageCount];
	...
	std::string m_vipexp;
	std::string m_totalrecharge;
	std::string m_cardPage;
	std::string m_itemPage;
...
//
//////////////////////////////////////////////////////////////////////////
class crJXJUILunHuiPageChangeMethod :public CRCore::crMethod
{//Client 
public:
	crJXJUILunHuiPageChangeMethod();
	crJXJUILunHuiPageChangeMethod(const crJXJUILunHuiPageChangeMethod& handle);
	MethodClass(JXJ, JXJUILunHuiPageChange)
	virtual void operator()(crHandle &handle);
	virtual void inputParam(int i, void *param);
	virtual void addParam(int i, const std::string& str);
protected:
	CRCore::crWidgetNode *m_this;
	std::string m_card[CycleCardOnePageCount];
	std::string m_item[CycleItemOnePageCount];
};
//////////////////////////////////////////////////////////////////////////
//
