...
void crJXJGameChatUIData::excHandle(CREPARAM msg)
{
...
void crJXJCheckAddFriendRequestData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJBeautyDialogueCanvasData::excHandle(CREPARAM msg)
{
	if(m_widgetnode)
		m_widgetnode->doEvent(LOCREPARAM(msg));
	else if(m_dataObject)
		m_dataObject->doEvent(LOCREPARAM(msg));
}
/////////////////////////////////////////
//
...
void crJXJRenWuCanvasData::inputParam(int i, void *param)
{
	...
	case WCHDATA_JXJRectCanvasName:
		m_rectCanvasName = param?*(std::string*)param:"";
		break;
...
void crJXJBattleRoomInfoData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJUIFxData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJGetRenWuRewardData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJUIBattlePunishData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJFubenCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJJueSeCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJGroupCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJMyGroupCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJCheckGroupCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJMyCountryCanvasData::inputParam(int i, void *param)
{
	...
	case WCHDATA_JXJMyCountryNotice:
		m_notice = param?*(std::string*)param:"";
		break;
...
void crJXJMyCountryCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crCenterNoticeCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJRankingCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJCardShopCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJProgressCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJTouchItemCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJGovPostShopCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJGongFangCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJAppointCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJArmyAdviserCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJOperationCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void JXJ::crJXJCheckAddGroupMemberRequestData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJTechCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void JXJ::crJXJJunTuanFuBenSettleCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void JXJ::crJXJFPSAndPingData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void JXJ::crHuodongCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crScenarioTalkCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crNewFunctionOpenCanvasData::excHandle(CREPARAM msg)
{
	if (LOCREPARAM(msg) == WCH_LockData)
	{
		if (HICREPARAM(msg))
...
void crXiaoguanjiaCanvasData::excHandle(CREPARAM msg)
{
	if (LOCREPARAM(msg) == WCH_LockData)
	{
		if (HICREPARAM(msg))
...
void JXJ::crChongZhiHuiKuiCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJJuntuanHuoDongUIData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJDelayHideCanvasUIData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
...
void crJXJTimerCanvasData::excHandle(CREPARAM msg)
{
	if(LOCREPARAM(msg) == WCH_LockData)
	{
		if(HICREPARAM(msg))
