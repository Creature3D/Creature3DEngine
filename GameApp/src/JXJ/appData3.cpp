...
void crJXJUIFormationJKData::inputParam(int i, void *param)
{
	...
	case WCHDATA_JXJForJKType:
		m_show_type = *((int*)param);
		break;
	case WCHDATA_JXJCurTiankaRow:
		m_curTainkaRow = *((int*)param);
		break;
	case WCHDATA_JXJCurDikaRow:
		m_curDikaRow = *((int*)param);
		break;
	case WCHDATA_JXJTiankaCount:
		m_tiankaCount = *((int*)param);
		break;
	case WCHDATA_JXJDikaCount:
		m_dikaCount = *((int*)param);
		break;
...
void crJXJUIFormationJKData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJUIBattleData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJUIDamageData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJUITongGaoData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJBattleBehaveData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJWorldFuBenData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJWorldStatusData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJUIAddArmyCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJFubenRewardCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJSweepCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJOnlineRewardCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJMoveCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJBattleShowCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJPersuadeCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJLandRewardCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJLunHuiCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crBattleJKCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crBufferWidgetData::excHandle(_crInt64 msg)
{
	if (LOINT64(msg) == WCH_LockData)
	{
		if (HIINT64(msg))
...
void crJXJChatChannelCanvasData::excHandle(_crInt64 msg)
{
	if(LOINT64(msg) == WCH_LockData)
	{
		if(HIINT64(msg))
...
void crJXJJuQingCanvasData::excHandle(_crInt64 msg)
{
	if (LOINT64(msg) == WCH_LockData)
	{
		if (HIINT64(msg))
...
void crBattleReportCanvasData::excHandle(_crInt64 msg)
{
	if (LOINT64(msg) == WCH_LockData)
	{
		if (HIINT64(msg))
...
void crJXJStarCanvasData::excHandle(_crInt64 msg)
{
	if (LOINT64(msg) == WCH_LockData)
	{
		if (HIINT64(msg))
...
void crHeadCanvasData::excHandle(_crInt64 msg)
{
	if (LOINT64(msg) == WCH_LockData)
	{
		if (HIINT64(msg))
