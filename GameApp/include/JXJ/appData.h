...
protected:
	...
	std::map<int,CRCore::crVector3i> m_troopsachievemap; //玩家兵种相关成就信息,vector[0]为玩家击杀此兵种数量,vector[1]为玩家此兵种死亡数量,vector[2]为玩家此兵种击杀数量
...
protected:
	...
	unsigned char m_damageCount;//伤害个数控制，0表示不限
};
...
{
public:
	crJXJPlayerStoreInfo():m_playerID(0),m_money(0),m_totalmoney(0),m_playerCycleCount(0){}
	int getPlayerId(){return m_playerID;}
	void setPlayerId(int playerid){m_playerID = playerid;}
