 ...
 *    FILE:           fxaa.glsl
 *
 *    DESCRIPTION:    http://www.geeks3d.com/20110405/fxaa-fast-approximate-anti-aliasing-demo-glsl-opengl-test-radeon-geforce/3/
 *
 *    CREATED BY:     Îâ²Æ»ª
 *
...
uniform sampler2D CRE_BaseMap; // 0
...
void main()
{
  ...
  gl_FragColor = PostFX(CRE_BaseMap, uv, 0.0);
}
