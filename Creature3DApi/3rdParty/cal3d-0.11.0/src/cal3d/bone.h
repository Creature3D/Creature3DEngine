...
public:
  ...
  void setRotationExtern(const CalQuaternion& rotation);//add by 吴财华
  void setTranslationExtern(const CalVector& translation);//add by 吴财华
private:
  ...
  bool m_externTransSetted;
  bool m_externRotationSetted;
  CalVector m_translationExtern;
  CalQuaternion m_rotationExtern;
};
