...
class CRGLTEXT_EXPORT crDefaultFont : public crFont
{
public:
    ...
    /** NOP with crDefaultFont since it only supports a single fixed sized font. */
    virtual void setSize(unsigned int width, unsigned int height);

    virtual crFont::Glyph* getGlyph(unsigned int charcode);
