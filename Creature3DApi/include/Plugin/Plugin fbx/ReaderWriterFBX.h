...
class ReaderWriterFBX : public CRIOManager::crReaderWriter
{
public:
    ReaderWriterFBX()
    {
    ...
    virtual WriteResult writeNode(const CRCore::crNode&, const std::string& filename, const CRIOManager::crReaderWriter::Options*) const;
};
