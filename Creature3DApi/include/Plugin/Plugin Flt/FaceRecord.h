...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SFace* getData() const { return (SFace*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SSingleVertexList* getData() const { return (SSingleVertexList*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SMorphVertexList* getData() const { return (SMorphVertexList*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SVector* getData() const { return (SVector*)m_pData; }
