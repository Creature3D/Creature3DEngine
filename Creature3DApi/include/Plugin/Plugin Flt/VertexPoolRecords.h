...
class VertexRecord : public AncillaryRecord
{
    public:
        ...
        virtual void accept(RecordVisitor& rv) { rv.apply(*this); }
//      virtual void traverse(RecordVisitor& rv);
        virtual SVertex* getData() const { return (SVertex*)m_pData; }
...
class NormalVertexRecord : public AncillaryRecord
{
    public:
        ...
        virtual void accept(RecordVisitor& rv) { rv.apply(*this); }
//      virtual void traverse(RecordVisitor& rv);
        virtual SNormalVertex* getData() const { return (SNormalVertex*)m_pData; }
...
class TextureVertexRecord : public AncillaryRecord
{
    public:
        ...
        virtual void accept(RecordVisitor& rv) { rv.apply(*this); }
//      virtual void traverse(RecordVisitor& rv);
        virtual STextureVertex* getData() const { return (STextureVertex*)m_pData; }
...
class NormalTextureVertexRecord : public AncillaryRecord
{
    public:
        ...
        virtual void accept(RecordVisitor& rv) { rv.apply(*this); }
//      virtual void traverse(RecordVisitor& rv);
        virtual SNormalTextureVertex* getData() const { return (SNormalTextureVertex*)m_pData; }
