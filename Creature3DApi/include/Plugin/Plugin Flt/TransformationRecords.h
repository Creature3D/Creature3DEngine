...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SMatrix* getData() const { return (SMatrix*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual STranslate* getData() const { return (STranslate*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SRotatAboutEdge* getData() const { return (SRotatAboutEdge*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SOldTranslate* getData() const { return (SOldTranslate*)m_pData; }
...
//      virtual SGroup* getData() const { return (SGroup*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
        ...
        virtual SPutTransform* getData() const { return (SPutTransform*)m_pData; }
...
//      virtual void traverse(RecordVisitor& rv);
		...
		virtual SGeneralMatrix* getData() const { return (SGeneralMatrix*)m_pData; }
//      virtual SGroup* getData() const { return (SGroup*)m_pData; }
