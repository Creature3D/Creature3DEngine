...
// include CRCore/Export simply for the Win32 #pragma to stop VisualStudio barffing
...
//#define CERR    CRCore::notify( CRCore::INFO ) << __FILE__ << ":" << __LINE__ << ": "
#define CERR2   CRCore::notify( CRCore::NOTICE )<< __FILE__ << ":" << __LINE__ << ": "
#define CERR3   CRCore::notify( CRCore::WARN ) << __FILE__ << ":" << __LINE__ << ": "
...
struct color32
{
    ...
    inline CRCore::crVector4 get()
    { return CRCore::crVector4( red(), green(), blue(), alpha()); }
};
...
struct color48      // version 11, 12 & 13
{
    ...
    inline float blue()     { return (float)_blue/255; }
    inline CRCore::crVector4 get()
    { return CRCore::crVector4( red(), green(), blue(), 1); }
};
