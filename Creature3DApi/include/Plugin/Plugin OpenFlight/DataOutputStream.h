...
public:
    ...
    void writeVec2f( const CRCore::crVector2& val );
    void writeVec3f( const CRCore::crVector3& val );
    void writeVec4f( const CRCore::crVector4& val );
    void writeVec3d( const CRCore::crVector3d& val );
