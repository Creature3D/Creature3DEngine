...
class dxfReader : public CRCore::Referenced
{
public:
    dxfReader() {}
    virtual ~dxfReader() {}
...
protected:
    CRIOManager::ifstream                _ifs;
    CRCore::ref_ptr<readerBase>    _reader;
};
