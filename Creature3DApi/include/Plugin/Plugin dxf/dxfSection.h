...
protected:
    bool _inLayerTable;
    CRCore::ref_ptr<dxfLayerTable>                _layerTable;
    std::vector<CRCore::ref_ptr<dxfTable> >    _others;
    CRCore::ref_ptr<dxfTable>                _currentTable;
};
...
protected:
    ...
    std::vector<CRCore::ref_ptr<dxfBlock> > _blockList;
};
