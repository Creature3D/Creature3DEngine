...
class dxfTable : public CRCore::Referenced
{
public:
	dxfTable() {}
	virtual ~dxfTable() {}
...
class dxfLayer : public CRCore::Referenced
{
public:
...
protected:
	std::map<std::string, CRCore::ref_ptr<dxfLayer> > _layers;
	CRCore::ref_ptr<dxfLayer> _currentLayer;
};
