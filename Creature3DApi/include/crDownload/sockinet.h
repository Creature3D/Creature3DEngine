...
#ifndef CRDOWNLOAD_SOCKINET_H
#define CRDOWNLOAD_SOCKINET_H

#include <CRCore/Referenced.h>

#include <CRDownload/sockstream.h>
...
class osockinet: public CRCore::Referenced, public osockstream
{
    public:
...
class iosockinet: public CRCore::Referenced, public iosockstream
{
    public:
