...
crCarMatterObject::crCarMatterObject()
{
}

crCarMatterObject::crCarMatterObject(const crCarMatterObject &matterObject,const CRCore::crCopyOp& copyop):
	crViewMatterObject(matterObject,copyop)
{
}

CRCore::crMatrixd crCarMatterObject::getViewMatrix()
{
	return m_matrix;
}

CRCore::crVector3f crCarMatterObject::getViewDirection()
{//
...
void crCarMatterObject::_create(dWorldID worldID, dSpaceID spaceID)
{
	dMass m;
	...
	//CRCore::notify(CRCore::ALWAYS)<<"crCarMatterObject::_create "<<m_initPosition<<std::endl;

	crViewMatterObject::_create(worldID,spaceID);
}

void crCarMatterObject::releaseObjects(CRCore::crState* state)
{
	crViewMatterObject::releaseObjects(state);
}

void crCarMatterObject::releaseOde()
{
	crViewMatterObject::releaseOde();
}

void crCarMatterObject::setEnableIntersect( bool enableIntersect)
{
