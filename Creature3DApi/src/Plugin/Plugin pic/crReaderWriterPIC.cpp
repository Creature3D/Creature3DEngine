...
class ReaderWriterPIC : public CRIOManager::crReaderWriter
{
    public:
        virtual const char* className() const { return "PIC crImage Reader"; }
        virtual bool acceptsExtension(const std::string& extension) const { return CRIOManager::equalCaseInsensitive(extension,"pic"); }
...
// reader/writer.
static CRIOManager::RegisterReaderWriterProxy<ReaderWriterPIC> g_readerWriter_PIC_Proxy;
