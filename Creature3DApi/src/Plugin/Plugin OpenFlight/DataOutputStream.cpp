...
void
DataOutputStream::writeVec2f( const CRCore::crVector2& val )
{
    writeFloat32( val.x() );
    writeFloat32( val.y() );
}
...
void
DataOutputStream::writeVec3f( const CRCore::crVector3& val )
{
    writeFloat32( val.x() );
    writeFloat32( val.y() );
    writeFloat32( val.z() );
...
void
DataOutputStream::writeVec4f( const CRCore::crVector4& val )
{
    writeFloat32( val.x() );
    writeFloat32( val.y() );
    writeFloat32( val.z() );
...
void
DataOutputStream::writeVec3d( const CRCore::crVector3d& val )
{
    writeFloat64( val.x() );
    writeFloat64( val.y() );
    writeFloat64( val.z() );
