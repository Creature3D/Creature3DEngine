...
//#include <CRCore/LightPointSystem>
...
class LightPoint : public PrimaryRecord
{
    ...
    int32   _drawOrder;
    uint32  _flags;
    CRCore::crVector3 _animationAxis;

    //CRCore::ref_ptr<CRCore::crLightPointNode> _lpn;
...
protected:
    ...
    virtual void readRecord(RecordInputStream& in, Document& document)
    {
        ...
        //_lpn = new CRCore::LightPointNode;
        //_lpn->setName(id);
...
class IndexedLightPoint : public PrimaryRecord
{
    ...
    //CRCore::ref_ptr<CRCore::LightPointNode> _lpn;
    CRCore::ref_ptr<LPAppearance> _appearance;
    CRCore::ref_ptr<LPAnimation> _animation;
...
public:
    ...
    virtual void addVertex(Vertex& vertex)
    {
        ...
        //        lp._sector = new CRCore::DirectionalSector(
        //            vertex._normal,
        //            CRCore::DegreesToRadians(_appearance->horizontalLobeAngle),
        //            CRCore::DegreesToRadians(_appearance->verticalLobeAngle),
        //            CRCore::DegreesToRadians(_appearance->lobeRollAngle));
        //    }

        //    // Blink sequence
        //    if (_animation.valid())
        //    {
        //        CRCore::BlinkSequence* blinkSequence = new CRCore::BlinkSequence;
        ...
        //            blinkSequence->addPulse(_animation->animationPeriod-_animation->animationEnabledPeriod, CRCore::crVector4(0,0,0,0));
        ...
        //                        color = CRCore::crVector4(0,0,0,0);
        //                        break;
...
protected:
    ...
    virtual void readRecord(RecordInputStream& in, Document& document)
    {
        ...
        //        CRCore::crStateSet* textureStateSet = tp->get(_appearance->texturePatternIndex);
        //        if (textureStateSet)
        //        {
        //            // Merge face stateset with texture stateset
        //            CRCore::crStateSet* stateset = _lpn->getOrCreateStateSet();
...
class LightPointSystem : public PrimaryRecord
{
    ...
    CRCore::ref_ptr<CRCore::crMultiSwitch> _switch;
    //CRCore::ref_ptr<CRCore::LightPointSystem> _lps;
...
protected:
    ...
    virtual void readRecord(RecordInputStream& in, Document& document)
    {
        ...
        _switch = new CRCore::crMultiSwitch;
       // _lps = new CRCore::LightPointSystem;
        ...
        //    case 0:
        //        _lps->setAnimationState( CRCore::LightPointSystem::ANIMATION_OFF );
        //        break;
        //    default:
        //    case 1:
        //        _lps->setAnimationState( CRCore::LightPointSystem::ANIMATION_ON );
        //        break;
        //    case 2:
        //        _lps->setAnimationState( CRCore::LightPointSystem::ANIMATION_RANDOM );
        //        break;
        //}

        if (_parent.valid())
            _parent->addChild(*((CRCore::crGroup*)_switch.get()));
    }
    ...
    virtual void dispose(Document& document)
    {
        ...
        {
            CRCore::crNode* child = _switch->getChild(i);
            //if (CRCore::LightPointNode* lpn = dynamic_cast<CRCore::LightPointNode*>(child))
