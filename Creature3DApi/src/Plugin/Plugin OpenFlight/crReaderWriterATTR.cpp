...
class crReaderWriterATTR : public CRIOManager::crReaderWriter
{
    public:
    
        virtual const char* className() const { return "ATTR crImage Attribute Reader/Writer"; }
...
crReaderWriter::ReadResult crReaderWriterATTR::readObject(const std::string& file, const crReaderWriter::Options* options) const
{
    using std::ios;
...
// reader/writer.
CRIOManager::RegisterReaderWriterProxy<crReaderWriterATTR> g_readerWriter_ATTR_Proxy;
