...
void Vertex::setCoord(const CRCore::crVector3& coord)
{
    _coord = coord;
}

void Vertex::setColor(const CRCore::crVector4& color)
{
    _color = color;
    _validColor = true;
}

void Vertex::setNormal(const CRCore::crVector3& normal)
{
    _normal = normal;
    _validNormal = true;
}

void Vertex::setUV(int layer, const CRCore::crVector2& uv)
{
