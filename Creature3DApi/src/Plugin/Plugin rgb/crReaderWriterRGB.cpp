...
class ReaderWriterRGB : public CRIOManager::crReaderWriter
{
    public:
        virtual const char* className() const { return "RGB crImage Reader/Writer"; }
        
        virtual bool acceptsExtension(const std::string& extension) const
        {
            return CRIOManager::equalCaseInsensitive(extension,"rgb") ||
                CRIOManager::equalCaseInsensitive(extension,"sgi") ||
                CRIOManager::equalCaseInsensitive(extension,"rgba") ||
                CRIOManager::equalCaseInsensitive(extension,"int") || 
                CRIOManager::equalCaseInsensitive(extension,"inta") ||
                CRIOManager::equalCaseInsensitive(extension,"bw");
        }
        ...
        WriteResult writeRGBStream(const CRCore::crImage& img, std::ostream &fout, const std::string& name) const
        {
            rawImageRec raw;
            raw.imagic = 0732;
        ...
        virtual WriteResult writeImage(const CRCore::crImage& img,std::ostream& fout,const CRIOManager::crReaderWriter::Options*) const
        {
...
// reader/writer.
static CRIOManager::RegisterReaderWriterProxy<ReaderWriterRGB> g_readerWriter_RGB_Proxy;
