...
class ReaderWriterGIF : public CRIOManager::crReaderWriter
{
    public:
        virtual const char* className() const { return "GIF crImage Reader"; }
        virtual bool acceptsExtension(const std::string& extension) const
        {
            return CRIOManager::equalCaseInsensitive(extension,"gif");
        }
...
// reader/writer.
static CRIOManager::RegisterReaderWriterProxy<ReaderWriterGIF> g_readerWriter_GIF_Proxy;
