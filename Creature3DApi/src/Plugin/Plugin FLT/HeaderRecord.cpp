...
void HeaderRecord::endian()
{
	...
	//CRCore::notify(CRCore::INFO)<<"fltRev: "<<pHeader->diFormatRevLev<<std::endl;
    ...
    //   SHeader struct, so that subsequent typecasts of m_pData work as expected.
    free( m_pData );
    m_pData = (SRecHeader*)pHeader;
