...
class ReaderWriterJPEG : public CRIOManager::crReaderWriter
{
        ...
        int getQuality(const CRIOManager::crReaderWriter::Options *options) const {
            if(options) {
    ...
    public:
        virtual const char* className() const { return "JPEG crImage Reader/Writer"; }
        virtual bool acceptsExtension(const std::string& extension) const
        {
            return CRIOManager::equalCaseInsensitive(extension,"jpeg") || CRIOManager::equalCaseInsensitive(extension,"jpg");
        }
        ...
        {
            CRCore::ref_ptr<CRCore::crImage> tmp_img = new CRCore::crImage(img);
...
// reader/writer.
static CRIOManager::RegisterReaderWriterProxy<ReaderWriterJPEG> g_readerWriter_JPEG_Proxy;
