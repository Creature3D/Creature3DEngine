...
int crText::getUnderLineCoordSize() const
{
	return m_underLineCoords.size();
}
const CRCore::crVector2& crText::getUnderLineCoord(int index)const
{
	return m_underLineCoords[index];
}
