...
void crBlowfish::genSubkeys(char *passwd)
{
...
void crBlowfish::BF_En(Word *x1,Word *x2)
{
	Word w1=*x1,w2=*x2;
...
void crBlowfish::BF_De(Word *x1,Word *x2)
{
	Word w1=*x1,w2=*x2;
...
void crBlowfish::setPasswd(char *passwd)
{
	unsigned int len;
...
void crBlowfish::encrypt(void *Ptr,unsigned int N_Bytes)
{
	unsigned int i;
	DWord *Work;
...
bool crBlowfish::decrypt(void *Ptr,unsigned int N_Bytes)
{
	unsigned int i;
	DWord *Work;
...
void main()
{
	...
	cout << "crBlowfish verification: ";
	if (result = Test(&BF))
	{
		cout << "\aFailed " << (result>0?"en":"de") << "crypting test vector " <<abs(result) << endl;
		return;
	}
	else
		cout << "Passed" << endl;
