...
*/
//
// Win32Barrier.c++ - C++ crBarrier class built on top of POSIX threads.
// ~~~~~~~~~~~~~~~~~~
//
...
#include  <CRCore/thread/crWin32BarrierPrivateData.h>
...
// Use: public.
//
crBarrier::crBarrier(int numThreads) {
...
// Use: public.
//
void crBarrier::block(unsigned int numThreads) {
    ...
    ScopedLock<crMutex> lock(pd->lock);
    if( m_valid )
    {
        my_phase = pd->phase;
        ++pd->cnt;
...
// Use: public
//
int crBarrier::numThreadsCurrentlyBlocked() {
