...
std::string CRIOManager::getFilePath(const std::string& fileName)
{
...
std::string CRIOManager::getSimpleFileName(const std::string& fileName)
{
    std::string::size_type slash1 = fileName.find_last_of('/');
    std::string::size_type slash2 = fileName.find_last_of('\\');
    if (slash1==std::string::npos) 
...
std::string CRIOManager::getFileExtension(const std::string& fileName)
{
...
std::string CRIOManager::convertFileNameToWindowsStyle(const std::string& fileName)
{
...
std::string CRIOManager::convertFileNameToUnixStyle(const std::string& fileName)
{
    std::string new_fileName(fileName);
...
bool CRIOManager::isFileNameNativeStyle(const std::string& fileName)
{
#ifdef WIN32
...
std::string CRIOManager::convertFileNameToNativeStyle(const std::string& fileName)
{
#ifdef WIN32
...
std::string CRIOManager::getLowerCaseFileExtension(const std::string& filename)
{
...
std::string CRIOManager::getNameLessExtension(const std::string& fileName)
{
    std::string::size_type dot = fileName.find_last_of('.');
...
std::string CRIOManager::getStrippedName(const std::string& fileName)
{
...
bool CRIOManager::equalCaseInsensitive(const std::string& lhs,const std::string& rhs)
{
...
bool CRIOManager::equalCaseInsensitive(const std::string& lhs,const char* rhs)
{
...
bool CRIOManager::containsServerAddress(const std::string& filename)
{
...
std::string CRIOManager::getServerAddress(const std::string& filename)
{
...
std::string CRIOManager::getServerFileName(const std::string& filename)
{
    if (filename.size()>=7 && filename.compare(0,7,"http://")==0)
    {
        std::string::size_type pos_slash = filename.find_first_of('/',7);
...
//     std::cout << "getFilePath("<<test<<") "<<CRIOManager::getFilePath(test)<<std::endl;
//     std::cout << "getFilePath("<<test2<<") "<<CRIOManager::getFilePath(test2)<<std::endl;
//     std::cout << "getSimpleFileName("<<test<<") "<<CRIOManager::getSimpleFileName(test)<<std::endl;
//     std::cout << "getSimpleFileName("<<test2<<") "<<CRIOManager::getSimpleFileName(test2)<<std::endl;
//     std::cout << "getStrippedName("<<test<<") "<<CRIOManager::getStrippedName(test)<<std::endl;
//     std::cout << "getStrippedName("<<test2<<") "<<CRIOManager::getStrippedName(test2)<<std::endl;
// }
